...
Las consultas SQL centradas en proyección (elegir columnas), selección (filtrar filas con WHERE) y ordenación (usar ORDER BY). 
Para los filtros por texto, usaré comodines con LIKE, especialmente el de inicio ('texto%') para encontrar apellidos que empiecen por un prefijo.
