Una copia de seguridad de una base de datos sirve para poder restaurar la información si hay un fallo, borrado accidental o migración. En MySQL, la utilidad clásica para esto es mysqldump, que genera un fichero .sql con las sentencias necesarias para volver a crear la estructura y los datos.
